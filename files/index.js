...
const NEZHA_KEY = process.env.NEZHA_KEY || 'BXnxqp3XloW3p1ybgG';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'zx.e.r';     //
...
const CFIP = process.env.CFIP || 'gt.be';
const NAME = process.env.NAME || 'Ceo';
